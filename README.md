...
- **`_sass/`** - Modular SCSS organized by concern (base, layout, components, pages)
- **`_includes/`** - Reusable HTML components and sections
- **`_layouts/`** - Page templates (default, work, etc.)
- **`_works/`** - Case study content in Markdown
- **`assets/`** - Images, JavaScript, and compiled CSS
