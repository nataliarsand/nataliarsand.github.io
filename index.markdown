...
<section id="my-craft">
  ...
  <div class="grid-cards" data-stagger="0.08">
    <div class="card">
      <h3>UX Craft & Quality</h3>
      <p>Flows, states, the empty and error screens nobody asks for, and the interface details that decide whether something feels considered. Handoff is one of my favorite parts: engineers get the what and the why, and build with ownership. Design is only done when it’s in the customer’s hands, not when it looks right in a Figma frame.</p>
      <ul class="pills">
    ...
    <div class="card">
      ...
      <p>I’ve designed and shipped live products end to end with AI as a build partner. I go back and forth on exploring the technology and incorporating new ways of working on top of the fundamentals, not instead of them. Nobody has this figured out yet, we’re building the future of design right now.</p>
      <ul class="pills">
